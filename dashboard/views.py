...
from master_penilaian.models import KegiatanPenilaianModel, MasterPenilaianPetugas, MasterNilaiPetugas
...
class MainDashboardClassView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        db_nilai = MasterNilaiPetugas.objects.values('indikator_penilaian__indikator_penilaian__nama_indikator', 'nilai').order_by('indikator_penilaian__indikator_penilaian__nama_indikator')

        for idx, dt in enumerate(db_nilai):
  
            check_exist = [index for (index, d) in enumerate(data) if d["nama"] == dt['indikator_penilaian__indikator_penilaian__nama_indikator']]
            ...
            data.append({
                'nama' : dt['indikator_penilaian__indikator_penilaian__nama_indikator'],
                'rerata' : 0,
                'data_lain': '27%',
        ...
        context = {
            ...
            'mitra_dinilai' : MasterPenilaianPetugas.objects.values('petugas').distinct().count(),
            'nilai_mitra': MasterPenilaianPetugas.objects.values('petugas', 'detail_nilai').distinct().count(),
        }
...
class DashboardRankClassView(LoginRequiredMixin, View):
    ...
    def _globalRank(self, request):
        data = MasterPenilaianPetugas.objects.values('petugas__petugas__kode_petugas', 'petugas__petugas__nama_petugas', 'petugas__sub_kegiatan__survey__nama', 'petugas__role__jabatan', 'detail_nilai__indikator_penilaian__kegiatan_penilaian', 'detail_nilai__indikator_penilaian__kegiatan_penilaian__kegiatan_survey__nama_kegiatan', 'detail_nilai__nilai')
        ...
        for dt in data:
            ...
            if len(check_exist) > 0:
                ...
                if len(check_exist_2) > 0:
                    ...
                    master_data[check_exist[0]]['kegiatan_penilaian'].append({
                        ...
                        'nama_kegiatan': dt['detail_nilai__indikator_penilaian__kegiatan_penilaian__kegiatan_survey__nama_kegiatan'],
            ...
            master_data.append({
                ...
                'rerata_final': 0,
                'ranking_final': 0,
                'kegiatan_penilaian' : [{'id_kegiatan': dt['detail_nilai__indikator_penilaian__kegiatan_penilaian'] , 'nama_kegiatan': dt['detail_nilai__indikator_penilaian__kegiatan_penilaian__kegiatan_survey__nama_kegiatan'], 'nilai': [dt['detail_nilai__nilai']]}]
            })
    ...
    def _datatables(self, request):
        ...
        data = MasterPenilaianPetugas.objects
        ...
        for dt in data:
            ...
            if len(check_exist) > 0:
                data_df[check_exist[0]]['rerata'].append(dt['detail_nilai__nilai'])
                continue
